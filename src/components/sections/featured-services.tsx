...
import { PackageOpen, Truck, BoxesIcon, ArrowRight } from "lucide-react";
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          {featuredServices.map((service) => (
            <div
              key={service.title}
              className="group relative p-8 rounded-2xl border border-border/50 bg-background hover:border-hrz-red/20 hover:shadow-lg hover:shadow-hrz-red/5 transition-all duration-300"
            >
              ...
              <h3 className="font-semibold text-xl text-hrz-blue mb-3">
                {service.title}
              </h3>
